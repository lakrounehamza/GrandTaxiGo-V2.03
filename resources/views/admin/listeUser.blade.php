                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-center">
                            <div class="flex item-center justify-center">
                                <a href="{{route('user.banni',$user->id)}}" class="w-4 mr-2 transform hover:text-red-500 hover:scale-110">
                            ...
                            <div class="flex item-center justify-center">
                                <a href="{{route('user.detail',$user->id)}}" class="w-4 mr-2 transform hover:text-red-500 hover:scale-110">
                                    detail
                                </a>
                            </div>
                            @endif
